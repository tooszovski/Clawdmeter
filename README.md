...
- [LilyGo T-Display-S3-Long](https://lilygo.cc/products/t-display-s3-long) — 3.4" 180×640 bar, used in landscape (640×180) with a two-account column layout (`lilygo_tdisplay_s3_long`)
